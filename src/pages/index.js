      ...
      >
        ...
        <div className='flex flex-col sm:flex-row justify-start'>
          <div className='text-center sm:text-left flex-1 py-8 pr-8 px-4 sm:px-0'>
            <h3 className='font-bold text-2xl pb-4 text-gray-900'>
              Um grande dia para o Gui!!
            </h3>
            <p className='text-lg py-4 pr-8 text-gray-500'>
              Veja em detalhes como o Hospital de olhos Freitag ajudou a fazer
              da vida do pequeno Gui uma vida mais alegre, com mais
              oportunidades para transformar o futuro da nossa sociedade!
            </p>
            <Button onClick={() => openWhatsUrl(CTA_WA_MESSAGES.headerTopCta)}>
              Fale conosco
            </Button>
          </div>
